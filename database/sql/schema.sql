...
DROP TABLE IF EXISTS apuracao_votos_cargo;

DROP TABLE IF EXISTS apuracao_votos_partido;

DROP TABLE IF EXISTS apuracao_votos_candidatura;
...
CREATE TABLE IF NOT EXISTS apuracao_votos_candidatura (
    id_apuracao_votos_candidatura INT NOT NULL GENERATED ALWAYS AS IDENTITY,
    id_candidatura                INT NOT NULL,
    id_boletim_urna               INT NOT NULL,
    total_votos_apurados          INT NOT NULL,

    PRIMARY KEY (id_apuracao_votos_candidatura),
...
CREATE TABLE IF NOT EXISTS apuracao_votos_cargo (
    id_apuracao_votos_cargo                  INT NOT NULL GENERATED ALWAYS AS IDENTITY,
    id_cargo_eleicao                         INT NOT NULL,
    id_boletim_urna                          INT NOT NULL,
    ...
    PRIMARY KEY (id_apuracao_votos_cargo),
    FOREIGN KEY (id_cargo_eleicao) REFERENCES cargo_eleicao (id_cargo_eleicao),
    FOREIGN KEY (id_boletim_urna)  REFERENCES boletim_urna (id_boletim_urna),
...
CREATE TABLE IF NOT EXISTS apuracao_votos_partido (
    id_apuracao_votos_partido INT NOT NULL GENERATED ALWAYS AS IDENTITY,
    id_partido                INT NOT NULL,
    id_boletim_urna           INT NOT NULL,
    id_eleicao                INT NOT NULL,
    ...
    PRIMARY KEY (id_apuracao_votos_partido),
    FOREIGN KEY (id_partido)      REFERENCES partido (id_partido),
    FOREIGN KEY (id_boletim_urna) REFERENCES boletim_urna (id_boletim_urna),
    FOREIGN KEY (id_eleicao)      REFERENCES eleicao (id_eleicao),
