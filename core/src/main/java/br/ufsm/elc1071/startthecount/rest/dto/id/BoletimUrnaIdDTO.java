...
public class BoletimUrnaIdDTO {
    ...
    public void validate() {
        if (
            ...
            throw new CamposFaltantesException("O username, código do pleito, número da seção, número da zona e a sigla da UF devem ser informados para buscar um boletim de urna.");
        }
    }
}
