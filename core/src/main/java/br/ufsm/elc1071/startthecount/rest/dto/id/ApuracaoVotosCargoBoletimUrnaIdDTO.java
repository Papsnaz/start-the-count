...
public class ApuracaoVotosCargoBoletimUrnaIdDTO {
    ...
    public void validate() {
        if (
            ...
            throw new CamposFaltantesException("O código do cargo, código da eleição, username, código do pleito, número da seção, número da zona e a sigla da UF devem ser informados para buscar uma apuração de votos de cargo de boletim de urna.");
        }
    }
}
