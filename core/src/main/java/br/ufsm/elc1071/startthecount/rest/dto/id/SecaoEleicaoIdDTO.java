...
public class SecaoEleicaoIdDTO {
    ...
    public void validate() {
        if (
            ...
            throw new CamposFaltantesException("O número da seção, número da zona, sigla da UF e o código da eleição devem ser informados para buscar uma instância de SecaoEleicao.");
        }
    }
}
