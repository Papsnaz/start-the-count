...
public class ZonaIdDTO {
    ...
    public void validate() {
        if (Objects.isNull(this.numeroZonaTSE) || StringUtils.isBlank(this.siglaUF)) {
            throw new CamposFaltantesException("O número da zona e a sigla da UF devem ser informados para buscar uma zona.");
        }
    }
}
