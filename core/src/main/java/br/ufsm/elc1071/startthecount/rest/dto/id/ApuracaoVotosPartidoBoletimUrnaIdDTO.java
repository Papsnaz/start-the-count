...
public class ApuracaoVotosPartidoBoletimUrnaIdDTO {
    ...
    @NotNull(message = "O número do partido não pode ser nulo.")
    private Integer numeroPartidoTSE;
    ...
    public void validate() {
        if (
            Objects.isNull(this.numeroPartidoTSE) ||
            ...
            throw new CamposFaltantesException("O número do partido, código da eleição, username, código do pleito, número da seção, número da zona e a sigla da UF devem ser informados para buscar uma apuração de votos de partido de boletim de urna.");
        }
    }
}
